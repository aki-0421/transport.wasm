...
// Original: https://github.com/golang/go/blob/go1.18.3/src/net/http/roundtrip_js.go
...
func (t *Transport) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	res, err := func() (*http.Response, error) {
		...
		// If not default, set value
		if t.Mode != FetchModeSameOrigin {
			opt.Set("mode", t.Mode.String())
		}
		// If not default, set value
		if t.Redirect != FetchRedirectFollow {
			opt.Set("redirect", t.Redirect.String())
		}
